...
var (
	...
	UIIndex                           = NewSetting("ui-index", "https://releases.rancher.com/ui/2.5.3/index.html")
	UIPath                            = NewSetting("ui-path", "/usr/share/rancher/ui")
	UIDashboardIndex                  = NewSetting("ui-dashboard-index", "https://releases.rancher.com/dashboard/v2.5.2/index.html")
