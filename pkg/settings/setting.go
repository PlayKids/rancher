...
var (
	...
	UIIndex                           = NewSetting("ui-index", "https://releases.rancher.com/ui/2.5.4/index.html")
	UIPath                            = NewSetting("ui-path", "/usr/share/rancher/ui")
	UIDashboardIndex                  = NewSetting("ui-dashboard-index", "https://releases.rancher.com/dashboard/v2.5.5/index.html")
